...
# Status
## Actions
status_logo_button = Open the NexusStudio Website ...
status_open_button = Open an existing NexusStudio project...
...
status_patreon_button = Visit the NexusStudio Patreon page. Thanks for your support.
status_help_button = Click on any UI element to visit the NexusStudio Online Documentation.
## Sidebar
...
info_welcome = Welcome to NexusStudio! Visit NexusStudio.com for information and example projects.
