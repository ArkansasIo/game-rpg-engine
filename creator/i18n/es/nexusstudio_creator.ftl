...
# Status
## Actions
status_logo_button = Abrir el sitio web de NexusStudio ...
status_open_button = Abrir un proyecto existente de NexusStudio...
...
status_patreon_button = Visita la página de Patreon de NexusStudio. Gracias por tu apoyo.
status_help_button = Haz clic en cualquier elemento de la UI para visitar la Documentación en línea de NexusStudio.
## Sidebar
...
info_welcome = ¡Bienvenido a NexusStudio! Visita NexusStudio.com para información y proyectos de ejemplo.
