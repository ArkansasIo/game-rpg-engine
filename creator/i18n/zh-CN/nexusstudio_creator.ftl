...
# Status
## Actions
status_logo_button = 打开 NexusStudio 官网
status_open_button = 打开已有的 NexusStudio 项目
...
status_patreon_button = 访问 NexusStudio 的 Patreon 页面，感谢支持。
status_help_button = 点击任意 UI 元素以访问 NexusStudio 在线文档。
## Sidebar
...
info_welcome = 欢迎使用 NexusStudio 访问 NexusStudio.com 获取信息和示例项目
