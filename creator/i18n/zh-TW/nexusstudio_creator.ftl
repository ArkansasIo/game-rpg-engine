...
# Status
## Actions
status_logo_button = 開啟 NexusStudio 官網
status_open_button = 開啟現有的 NexusStudio 專案
...
status_patreon_button = 造訪 NexusStudio 的 Patreon 頁面，感謝您的支持。
status_help_button = 點擊任何 UI 元素以造訪 NexusStudio 線上文件。
## Sidebar
...
info_welcome = 歡迎使用 NexusStudio 造訪 NexusStudio.com 以取得資訊與示例專案
