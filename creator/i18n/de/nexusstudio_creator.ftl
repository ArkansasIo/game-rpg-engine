...
# Status
## Actions
status_logo_button = Die NexusStudio-Website öffnen ...
status_open_button = Ein bestehendes NexusStudio-Projekt öffnen...
...
status_patreon_button = Die NexusStudio-Patreon-Seite besuchen. Danke für die Unterstützung.
status_help_button = Auf ein beliebiges UI-Element klicken, um die NexusStudio-Online-Dokumentation zu öffnen.
## Sidebar
...
info_welcome = Willkommen bei NexusStudio! Besuche NexusStudio.com für Informationen und Beispielprojekte.
