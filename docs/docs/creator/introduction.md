...
At the bottom of the screen you see the currently active **dock**, in this screenshot the tile picker. To the right of the **dock** area is the **action list**, it lists all [actions](actions/) which can be performed at the current moment (depending on the selected geometry, item and camera).
