...
![NexusStudio v0.8.100](/img/NexusStudiov0.8.100.png)

NexusStudio v0.8.100 introduces many new features and bug fixes.
...
But this release also includes dozens of smaller features. I tried to make **NexusStudio Creator** easier to use and fixed many bugs as well.

The documentation on this website has been nearly completely rewritten and should now reflect the current state of **NexusStudio**.
