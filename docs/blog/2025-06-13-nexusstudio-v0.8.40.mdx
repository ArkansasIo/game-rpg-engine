---
title: NexusStudio v0.8.40 Released
authors: [markusm]
tags: [releases]
---
...
## NexusStudio v0.8.40 Released

NexusStudio v0.8.40 introduces a range of major new features for building retro-style RPGs:
...
- **Node-based render graphs**
  All geometry in NexusStudio—including characters, terrain, and items—is now driven by flexible, modular node graphs.
